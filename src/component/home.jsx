...
class Home extends React.Component {
    ...
    componentDidMount() {
        axios.get("https://api.kawalcorona.com/positif/").then(res => {
            this.setState({
                pl: true,
                positif: res.data.value
            });
        });
        axios.get("https://api.kawalcorona.com/sembuh/").then(res => {
            this.setState({
                sl: true,
                sembuh: res.data.value
            });
        });
        axios.get("https://api.kawalcorona.com/meninggal/").then(res => {
            this.setState({
                ml : true,
                meninggal: res.data.value
            });
        });
